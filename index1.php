    ...
    <body class="backdrop">
        <script type="text/babel">
                ...
                render() {
                    ...
                    let body = (
                        <div id="contri">
                            ...
                            <hr />
                            <div class="col-lg-4">
                                <a href="#" type="button" class="btn col_btn" value="recipe" onClick={this.recipeForm}>A New Recipe</a>
                            </div>
                            <div class="col-lg-4">
                                <a href="#" type="button" class="btn col_btn" value="tip" onClick={this.tipForm}>A New Tip or Trick</a>
                            </div>
                            <div class="col-lg-4">
                                <a href="#" type="button" class="btn col_btn" value="ingredient" onClick={this.ingForm}>A New Ingredient</a>
                            </div>
                            <div id="tipForm" style={hide}><TipsForm /></div>
                            <div id="recipeForm" style={hide}><RecipeForm /></div>
                            <div id="ingForm" style={hide}><IngForm /></div>
                        </div>
                    ...
                    let body = (
                        <div align="center">
                            ...
                            <div class="col-lg-6" align="center">
                                <h3 class="col_text">New Ingredient</h3>
                                <hr />
                                <form action="#" method="post" name="newIng" id="newIng">
                                    <table border="0" cellpadding="5">
                                        <tr>
                                            <td colspan="2">Supply known values for 100g of this ingredient:</td>
                                        </tr> 
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control" name="fat" id="fat" min="0" /> g
                                            </td>
                                            </div>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control" name="carbs" id="carbs" min="0" /> g
                                            </td>
                                            </div>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control" name="sugar" id="sugar" min="0" /> g
                                            </td>
                                            </div>
                                        </tr>
                                        <tr>
                                            <div class="form-group">
                                            <td>
                                                <label for="v_m">Vitamins & Minerals: </label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td colspan="2"><input type="submit" class="btn col_btn" value="Save" /></td>
                                        </tr>                    
                                    </table>
                                </form>
                            </div>
                ...
                render() {
                    let body = (
                        <div align="center">
                            <div class="col-lg-3"></div>
                            <div class="col-lg-6">
                                <h3 class="col_text">New Tip or Trick</h3>
                                <hr />
                                <form action="#" method="post" name="newTip" id="newTip">
                                    <table border="0" cellpadding="5">
                                        ...
                                        <tr>
                                            <td colspan="2"><input type="submit" value="Save" class="btn col_btn" /></td>
                                        </tr>                    
                                    </table>
                                </form>
                            </div>
            ...
            class RecipeForm extends React.Component {
                ...
                showIngs = (e) => {
                    if (document.getElementById("ings") != null) {
                        ...
                        for (let i = 0; i < n; i++) {
                            ...
                            var txt = document.createTextNode("Salt");
                            defOp.appendChild(txt);
                            defOp.setAttribute("value", txt);
                            ingSelect.appendChild(defOp);
                            var allIng = this.state.allIngs;
                            for(var j = 0; j < allIng.length; j++)
                            {
                                var opt = document.createElement("option"),
                                t = document.createTextNode(allIng[j]);
                                opt.appendChild(t);
                                opt.setAttribute("value", allIng[j]);
                                ingSelect.insertBefore(opt, ingSelect.lastChild);
                            }
                            r.appendChild(ingSelect);

                            var unitSelect = document.createElement("select");
                            defOp = document.createElement("option");
                            txt = document.createTextNode("To Taste");
                            defOp.appendChild(txt);
                            defOp.setAttribute("value", txt);
                            unitSelect.appendChild(defOp);
                            var u = this.state.units;
                            for(var j = 0; j < u.length; j++)
                            {
                                var opt = document.createElement("option"),
                                t = document.createTextNode(u[j]);
                                opt.appendChild(t);
                                opt.setAttribute("value", u[j]);
                                unitSelect.insertBefore(opt, unitSelect.lastChild);
                            }
                            r.appendChild(unitSelect);
                            //r.innerHTML = "Choose ingredient "+(i + 1)+"and its quantity:";
                        }
                    }
                }
                ...
                render() {
                   ...
                   let uname = <?php echo $_SESSION['UserName'];  ?>;
                    let body = (
                        <div align="center">
                            <div class="col-lg-3"></div>
                            <div class="col-lg-6">
                                <h3 class="col_text">New Recipe</h3>
                                <hr />
                                <form action="" method="post" name="newRecipe" id="newRecipe">
                                    <table border="0" cellpadding="5">
                                        ...
                                        <tr>
                                            <div class="form-group">
                                            <td>
                                                <label for="ingQty">No. of Ingredients: </label>
                                            </td>
                                            <td>
                                                <input type="number" class="form-control" name="ingQty" id="ingQty" min="1" max="25" />
                                            </td>
                                            </div>
                                        </tr>
                                        <tr id="ings"></tr>
                                        ...
                                        <tr>
                                            ...
                                            <div class="form-group">
                                            <td>
                                                <label for="recipePic">Recipe Image: </label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="hidden" name="userName" id="userName" value="<?php echo $_SESSION['UserName']  ?>" /><?php echo $_SESSION['UserName']  ?>                                        
                                            </td>
                                            </div>
                                        </tr> 
                                        <tr>
            ...
            class Favorites extends React.Component {
                ...
                render() {
                    ...
                    body = (
                        <div>
                            <h3 class="col_text">Here are your bookmarked recipes, {this.state.userName}</h3>
                            <hr />
                            {list}
                        </div>
                    );
                ...
                <div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" onclick="">Hello 
                            <span id="uname">Guest</span> <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu">
                        ...
                        <script type="text/javascript">
                            /*if (typeof(Storage) !== "undefined") {
                                if (sessionStorage.getItem("UserName") != "Rini") {
                                sessionStorage.setItem("UserName", "Guest");
                                document.getElementById("uname").innerHTML = sessionStorage.getItem("UserName");
                                var li = document.createElement("li");
                                li.setAttribute("data-toggle", "modal");
                                li.setAttribute("data-target", "#reg");
                                li.innerHTML = "<a>Register</a>";
                                document.getElementById("dropdown").appendChild(li);
                                var li2 = document.createElement("li");
                                li2.setAttribute("data-toggle", "modal");
                                li2.setAttribute("data-target", "#signin");
                                li2.innerHTML = "<a>Sign In</a>";
                                document.getElementById("dropdown").appendChild(li2);
                                }
                            } else {
                                alert("Not supported");
                            }*/
                            ...
                            function login() {
                                ...
                                if (document.getElementById('loginEmail').value == "abhi@gmail.com") {
                                    ...
                                    var li = document.createElement("li");
                                    li.setAttribute("onclick", "getContributor();");
                                    li.innerHTML = "<a href='#'>Contribute</a>";
                                    document.getElementById("dropdown").appendChild(li);
                                    var li2 = document.createElement("li");
                                    li2.setAttribute("onclick", "getFavorites();");
                                    li2.innerHTML = "<a href='#'>Favorites</a>";
                                    document.getElementById("dropdown").appendChild(li2);
                                    var li3 = document.createElement("li");
                                    li3.setAttribute("onclick", "logout();");
                                    li3.innerHTML = "<a href='#'>Log Out</a>";
                                    document.getElementById("dropdown").appendChild(li3);*/
                                }
                            }
